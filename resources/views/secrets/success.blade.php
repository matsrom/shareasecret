<x-app-layout>
    <div class="flex flex-col items-center justify-center mt-56">
        ...
        <div class="flex flex-row gap-2 justify-center items-center mt-8">
            <x-text-input id="result" class="block w-96 h-9" type="text" value="{{ $shareLink }}" readonly />
        ...
        <div class="mt-8">
            ...
            @if ($secret->keep_track)
                <p>This secret has been configured to be tracked by you hand has been given the </p>
            @endif
        </div>
    </div>
